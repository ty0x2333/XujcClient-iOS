...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        _imageNames = @[@[@"cell_icon_detail"], @[@"cell_icon_detail"], @[@"cell_icon_home", @"cell_icon_settings"], @[@"cell_icon_share"]];
    }
    return self;
}
...
- (UserDetailViewModel *)userDetailViewModel
{
    ...
    RAC(viewModel, phone) = [[[userSignal map:^id(UserModel *value) {
        return value.phone;
    }] setNameWithFormat:@"PersonalViewModel phoneSignal"] logAll];
